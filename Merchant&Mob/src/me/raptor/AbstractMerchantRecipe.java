...
public abstract class AbstractMerchantRecipe {
	...
	public static void addBasicCurrencyRecipe(List<MerchantRecipe> list) {
		addRecipe(Currency.penny(8), new ItemStack(Material.EMERALD, 1), 10000, true , list);
		addRecipe(Currency.penny(7), new ItemStack(Material.GOLD_INGOT, 1), 10000, true , list);
